...
export function printConsoleWarning() {
	...
	console.log(
		`%c${bigText}`,
		'color:#ef4444; font-family: monospace; font-weight: bold; font-size: 12px;'
	);
	...
	console.log(
		...
		'color:#f3f4f6; font-size: 14px; line-height: 1.5;'
	);

	console.log(
		'%cLearn more: https://colbe.cc/privacy',
		'color:#3b82f6; font-size: 13px; text-decoration: underline;'
	);
}